package br.com.mellies.command.alexa.before.alexa;

import java.util.HashMap;
import java.util.Map;

import br.com.mellies.command.alexa.before.lights.PhillipsHueLight;
import br.com.mellies.command.alexa.before.lights.XiaomiLight;
