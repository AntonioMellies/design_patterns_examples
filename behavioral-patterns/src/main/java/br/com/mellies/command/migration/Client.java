package br.com.mellies.command.migration;

import java.util.LinkedHashMap;
import java.util.List;
import java.util.Map;

import br.com.mellies.command.migration.commands.ProductTable;
import br.com.mellies.command.migration.commands.UserTable;
import br.com.mellies.command.migration.commands.UserTableRoleColumn;
